...
// ¡VERSIÓN FINAL COMPLETA con toda la lógica de funciones restaurada!
// ==========================================================
...
const styles = StyleSheet.create({
    container: { flex: 1, padding: 20, backgroundColor: '#f8f9fa' }, header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }, input: { width: '100%', height: 45, borderColor: '#ccc', borderWidth: 1, borderRadius: 8, marginBottom: 15, paddingHorizontal: 10 }, inputError: { borderColor: '#DC2626', }, errorText: { color: '#DC2626', fontSize: 12, alignSelf: 'flex-start', marginTop: -10, marginBottom: 10, }, headerTitle: { fontSize: 24, fontWeight: 'bold' }, addButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#720819', paddingHorizontal: 15, paddingVertical: 10, borderRadius: 8 }, addButtonText: { color: '#fff', marginLeft: 10 }, contentContainer: { flex: 1, flexDirection: 'row' }, projectsSidebar: { width: 250, backgroundColor: '#fff', padding: 15, borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 5 }, projectsSidebarTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 15 }, projectsList: { flex: 1 }, projectItem: { paddingVertical: 15, paddingHorizontal: 10, marginBottom: 5, borderRadius: 8 }, projectItemActive: { backgroundColor: '#f0e6e8' }, projectCode: { fontSize: 12, color: '#888' }, projectName: { fontWeight: 'bold', fontSize: 16, color: '#333' }, tasksContainer: { flex: 1, marginLeft: 20 }, tasksHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }, tasksHeaderTitle: { fontSize: 24, fontWeight: 'bold', flexShrink: 1, marginRight: 10 }, headerActions: { flexDirection: 'row', alignItems: 'center', gap: 16 }, addTaskButton: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8, paddingHorizontal: 12, borderRadius: 8, backgroundColor: '#FEE2E2' }, addTaskButtonText: { color: '#720819', fontWeight: 'bold', marginLeft: 8 }, viewModeButtons: { flexDirection: 'row', backgroundColor: '#f0f0f0', borderRadius: 8, padding: 5 }, viewButton: { padding: 10, borderRadius: 5 }, viewButtonActive: { backgroundColor: '#720819' }, kanbanBoard: { flexGrow: 1, flexDirection: 'row', gap: 10 }, kanbanColumn: { width: 250, backgroundColor: '#fff', padding: 10, borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 2 }, kanbanColumnTitle: { fontSize: 16, fontWeight: 'bold', marginBottom: 10, textAlign: 'center' }, taskCard: { backgroundColor: '#f9f9f9', padding: 10, marginBottom: 10, borderRadius: 8, borderWidth: 1, borderColor: '#eee' }, taskCardCode: { fontSize: 10, color: '#aaa' }, taskCardName: { fontSize: 14, fontWeight: 'bold', marginVertical: 5 }, taskCardInfo: { flexDirection: 'row', alignItems: 'center', marginBottom: 5 }, taskCardInfoText: { fontSize: 12, color: '#666', marginLeft: 5 }, taskStatus: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 15, alignSelf: 'flex-start', marginTop: 5 }, taskStatusText: { color: '#fff', fontWeight: 'bold', fontSize: 10 }, taskCardButtons: { flexDirection: 'row', justifyContent: 'flex-end', gap: 10, marginTop: 10 }, detailsButton: { padding: 5, borderRadius: 5 }, detailsButtonText: { color: '#720819', fontWeight: 'bold', fontSize: 12 }, editButton: { padding: 5, borderRadius: 5 }, editButtonText: { color: '#337ab7', fontWeight: 'bold', fontSize: 12 }, dropZone: { flex: 1, minHeight: 100 }, dropInstruction: { textAlign: 'center', fontStyle: 'italic', color: '#aaa', marginTop: 10, padding: 10, borderWidth: 1, borderStyle: 'dashed', borderColor: '#ccc', borderRadius: 5 }, listContainer: { flex: 1 }, listScrollView: { flex: 1 }, taskListItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, marginBottom: 10, backgroundColor: '#fff', borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 5 }, taskListItemContent: { flex: 1 }, taskListItemName: { fontSize: 16, fontWeight: 'bold' }, taskListItemInfo: { flexDirection: 'row', flexWrap: 'wrap', marginTop: 5 }, taskListItemDetails: { fontSize: 12, color: '#666', marginRight: 15 }, filterContainer: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', marginBottom: 20, padding: 10, backgroundColor: '#f0f0f0', borderRadius: 8 }, filterLabel: { fontWeight: 'bold', marginRight: 10, color: '#333' }, filterButton: { paddingHorizontal: 15, paddingVertical: 8, borderRadius: 20, backgroundColor: '#e0e0e0', marginRight: 10, marginBottom: 5 }, filterButtonActive: { backgroundColor: '#720819' }, filterButtonText: { color: '#333', fontWeight: 'bold' }, filterButtonTextActive: { color: '#fff' }, centeredView: { flexGrow: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.5)', paddingVertical: 20 }, modalView: { margin: 20, backgroundColor: 'white', borderRadius: 20, padding: 35, width: '90%', maxWidth: 500, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 5 }, modalTitle: { fontSize: 20, fontWeight: 'bold', marginBottom: 20, alignSelf: 'center' }, detailsSection: { flexDirection: 'row', marginBottom: 10, alignItems: 'flex-start' }, detailsLabel: { fontWeight: 'bold', marginRight: 5, color: '#333' }, detailsText: { flex: 1, flexWrap: 'wrap', color: '#555' }, textArea: { height: 100, textAlignVertical: 'top', paddingTop: 10 }, datePickerContainer: { width: '100%', marginBottom: 15 }, dateLabel: { fontWeight: 'bold', marginBottom: 5, color: '#333' }, dateInput: { borderColor: '#ccc', borderWidth: 1, borderRadius: 8, padding: 12, marginBottom: 10, width: '100%', color: '#333', textAlign: 'center' }, buttonContainer: { flexDirection: 'row', justifyContent: 'flex-end', marginTop: 20, width: '100%', gap: 10 }, button: { borderRadius: 8, paddingVertical: 10, paddingHorizontal: 20, elevation: 2 }, buttonClose: { backgroundColor: '#6c757d' }, buttonAdd: { backgroundColor: '#720819' }, textStyle: { color: 'white', fontWeight: 'bold', textAlign: 'center' }, emptyStateContainer: { flex: 1, justifyContent: 'center', alignItems: 'center' }, emptyStateText: { fontSize: 18, fontWeight: 'bold', color: '#6c757d' }, emptyStateSubtext: { fontSize: 14, color: '#adb5bd', marginTop: 5 }, pickerLabel: { fontSize: 14, fontWeight: 'bold', color: '#333', marginBottom: 5, alignSelf: 'flex-start' }, pickerContainer: { width: '100%', borderColor: '#ccc', borderWidth: 1, borderRadius: 8, marginBottom: 15, justifyContent: 'center' }, datePickerModalView: { width: '90%', maxWidth: 350, backgroundColor: 'white', borderRadius: 20, padding: 20, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 5 }, datePickerNavigation: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: 10 }, datePickerNavButton: { fontSize: 24, fontWeight: 'bold', color: '#720819' }, datePickerMonthYear: { fontSize: 18, fontWeight: 'bold', textTransform: 'capitalize' }, dayNamesContainer: { flexDirection: 'row', width: '100%', justifyContent: 'space-around', borderBottomWidth: 1, borderBottomColor: '#eee', marginBottom: 5, paddingBottom: 5 }, dayName: { textAlign: 'center', fontWeight: 'bold', color: '#888', width: 40 }, datePickerGridContainer: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around' }, datePickerDay: { width: 40, height: 40, justifyContent: 'center', alignItems: 'center', borderRadius: 20, margin: 2 }, dayCellOutsideMonth: { opacity: 0.3 }, dayText: { fontSize: 14, color: '#333' },
});
